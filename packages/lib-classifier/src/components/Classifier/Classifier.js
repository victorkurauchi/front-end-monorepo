...
export default class Classifier extends React.Component {
  ...
  componentDidMount () {
    const { onAddToCollection, onCompleteClassification, onToggleFavourite, project, subjectId, subjectSetID, workflowID } = this.props
    ...
    this.classifierStore.workflows.selectWorkflow(workflowID, subjectSetID, subjectId)
  }
